...
export function AIAssistant() {
  ...
  function buildContext(): string {
    ...
    if (isRolplayPage && rpSessions.length > 0) {
      ...
      ctx +=
        ...
        `Sessions: ${rpKpis.totalSessions} | Avg Score: ${rpKpis.avgTotalScore} pts | ` +
    ...
    if (kpis && !dashLoading) {
      ...
      ctx +=
        ...
        'coaching best practices, or the Gentera Rolplay platform.'
    }
  ...
  const greeting = language === 'es'
    ? `¡Hola! Soy el asistente IA de Gentera. Estás en **${pageName}**. Puedo analizar el rendimiento del equipo, identificar áreas de mejora y generar perspectivas. También puedes **pegar o adjuntar imágenes** del dashboard para análisis visual. ¿En qué te puedo ayudar?`
    : `Hello! I'm the Gentera AI assistant. You're viewing **${pageName}**. I can analyze team performance, identify improvement areas, and generate data-driven insights. You can also **paste or attach dashboard screenshots** for visual analysis. How can I help?`
